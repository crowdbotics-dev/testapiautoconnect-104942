...
## Project Structure
    ...
    ├── testapiautoconnect_104942  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_104942`
...
2. Clone this repo and `cd testapiautoconnect_104942`
